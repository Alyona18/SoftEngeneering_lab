...
from grammar.pocketsLexer import pocketsLexer
from grammar.pocketsParser import pocketsParser

from grammar.pocketsListener import pocketsListener
...
if __name__ == "__main__":
    fname = "D:/softengeneering/sql_parser/test.txt"
    with open(fname) as f:
        text_input = f.readlines()
        for line in text_input:
            path = 'D:/softengeneering/sql_parser/data'
            parser = SQLParser(path)
            parser.parse_sql(line)